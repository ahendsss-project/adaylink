...
@section('subtitle', 'Panel Administrasi')

@section('content')
    <h2 class="text-xl font-semibold text-gray-700 text-center mb-6">Masuk ke Panel Admin</h2>
    ...
    <form method="POST" action="{{ route('admin.login.post') }}" x-data="{ showPassword: false }">
        @csrf
